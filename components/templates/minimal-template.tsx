...
export function MinimalTemplate({ data }: { data: ResumeData }) {
  return (
    <div className="max-w-3xl mx-auto font-sans bg-white">
      {/* Header */}
      <div className="mb-4">
        <h1 className="text-3xl font-light text-slate-900 mb-0.5 leading-tight">{data.personalInfo.fullName}</h1>
        {data.personalInfo.title && (
          <p className="text-base text-slate-600 font-light mb-1.5">{data.personalInfo.title}</p>
        )}
      ...
      {data.personalInfo.summary && (
        <div className="mb-4">
          <p className="text-slate-700 text-xs leading-relaxed">{data.personalInfo.summary}</p>
        </div>
      )}
      ...
      {data.experience.length > 0 && (
        <div className="mb-4">
          <h2 className="text-xs font-semibold text-slate-900 mb-2 uppercase tracking-widest">Experience</h2>
      ...
      {data.education.length > 0 && (
        <div className="mb-4">
          <h2 className="text-xs font-semibold text-slate-900 mb-2 uppercase tracking-widest">Education</h2>
      ...
      {data.projects.length > 0 && (
        <div className="mb-4">
          <h2 className="text-xs font-semibold text-slate-900 mb-2 uppercase tracking-widest">Projects</h2>
          <div className="space-y-2">
      ...
      {data.certifications.length > 0 && (
        <div className="mb-4">
          <h2 className="text-xs font-semibold text-slate-900 mb-2 uppercase tracking-widest">Certifications</h2>
          <div className="space-y-1.5">
            {data.certifications.map((cert) => (
              <div key={cert.id}>
                <p className="font-semibold text-slate-900 text-sm leading-tight">{cert.name}</p>
      ...
      {data.languages.length > 0 && (
        <div className="mb-4">
          <h2 className="text-xs font-semibold text-slate-900 mb-2 uppercase tracking-widest">Languages</h2>
      ...
      {data.skills.length > 0 && (
        <div>
          <h2 className="text-xs font-semibold text-slate-900 mb-2 uppercase tracking-widest">Skills</h2>
