...
export function CreativeTemplate({ data }: { data: ResumeData }) {
  return (
    <div className="w-full font-sans bg-white">
      <div className="bg-blue-600 text-white p-6 mb-5 rounded-none">
        <h1 className="text-4xl font-bold mb-2 leading-tight tracking-tight">{data.personalInfo.fullName}</h1>
        {data.personalInfo.title && <p className="text-lg font-light mb-3 opacity-95">{data.personalInfo.title}</p>}
      ...
      {data.experience.length > 0 && (
        <div className="mb-5">
          <h2 className="text-xl font-bold text-blue-600 mb-4 pb-2 border-b-2 border-blue-600 uppercase tracking-wide">
        ...
        <div className="mb-5">
          ...
          <div className="space-y-3">
            {data.projects.map((proj) => (
              <div key={proj.id} className="pl-0">
                <div className="flex justify-between items-baseline mb-1">
        ...
        <div className="mb-5">
          ...
          <div className="space-y-2">
            {data.certifications.map((cert) => (
              <div key={cert.id} className="pl-0">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {data.skills.map((skill) => (
              <span key={skill} className="px-3 py-1.5 bg-blue-600 text-white rounded-md font-medium text-sm">
                {skill}
              </span>
            ))}
          </div>
